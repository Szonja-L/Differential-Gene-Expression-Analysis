...
# Load data
results  = pd.read_csv('results/dge_results_genes.csv')
...
ax.set_title('Differential Gene Expression\nBreast Cancer Tumor vs. Normal Breast Tissue',
...
plt.tight_layout()
plt.savefig('figures/01_volcano_plot.png', dpi=180, bbox_inches='tight')
plt.close()
...
plt.tight_layout()
plt.savefig('figures/02_heatmap.png', dpi=180, bbox_inches='tight')
plt.close()
print("  ✓ Heatmap saved")
...
plt.tight_layout()
plt.savefig('figures/03_pca_plot.png', dpi=180, bbox_inches='tight')
plt.close()
...
plt.tight_layout()
plt.savefig('figures/04_biomarker_boxplots.png',
